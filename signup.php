...
if ($_POST) {
  ...
  if(empty($msg_error)){
    ...
    if($result->rowCount() ==1){
      ...
      $result = $pdo->prepare("INSERT INTO user (pseudo, pwd, email, firstname, lastname, gender, city, address, privilege, picture, question) VALUES (:pseudo, :pwd, :email, :firstname, :lastname, :gender, :city, :address,0, :picture)");
